<h2 style="margin: 2%">Prodotto dopo l'applicazione della lavorazione</h2>

<form action="process-op8-3.php" method="POST" style="margin: 2%" enctype="multipart/form-data">
  <div class="form-row">
